...
def test_user_can_create_comment(
    client_loggin, news_detail_url, news, author, form_data
):
...
def test_user_can_edit_or_delete_own_comment(
    client_loggin, news, comment, url_name, method
):
...
def test_user_cant_edit_or_delete_comment_of_another_user(
    client, comment, auth_user, url_name
):
